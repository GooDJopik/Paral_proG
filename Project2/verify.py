...
plt.plot(matrix_sizes, execution_times, color='green', marker='o')
plt.xlabel("Размер матриц")
plt.ylabel("Время выполнения (с)")
plt.title("Зависимость времени выполнения от размера матриц для CUDA")
plt.grid()
plt.savefig("results/timing_graph.png")
